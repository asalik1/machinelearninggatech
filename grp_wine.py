...
df_grp_kmeans.columns.values[-z:] = ['Comp 1','Comp 2', 'Comp 3', 'Comp 4']
...
# Can only go up to 9
df_em.columns.values[-z:] = ['Comp 1','Comp 2', 'Comp 3','Comp 4']
