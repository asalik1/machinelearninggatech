...
comp_one = scores_pca[:,0]
comp_two = scores_pca[:,1]
comp_three = scores_pca[:,2]
...
df_pca_kmeans.columns.values[-2:] = ['Comp 1','Comp 2']
...
# df_em.columns.values[-8:] = ['Comp 1','Comp 2', 'Comp 3','Comp 4','Comp 5','Comp 6', 'Comp 7', 'Comp 8']
# Can only go up to 9
