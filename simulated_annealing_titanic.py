...
lr_model1 = mlrose.NeuralNetwork(hidden_nodes = [128], activation = 'relu', 
                                 ...
                                 max_iters = 7000, bias = True, is_classifier = True, 
                                 learning_rate = 0.7, early_stopping = True, 
...
# best_state, best_fitness, fitness_curve = mlrose.simulated_annealing(problem, schedule=mlrose.ExpDecay(), max_attempts=100, 
#                                                                     max_iters=7000, init_state=None, curve=True, random_state=None)
# print(best_fitness)
...
# fitness_fn = mlrose.SixPeaks(t_pct=0.1)
# problem  = mlrose.DiscreteOpt(length, fitness_fn, maximize=True, max_val=2)
# runner_return = mlrose.SARunner(problem, experiment_name="SA_Exp", 
#                            iteration_list=[10000],
#                            temperature_list=[1, 10, 50, 100, 250, 500, 1000, 2500, 5000],
#                            decay_list=[mlrose.ExpDecay,
#                                        mlrose.GeomDecay],
#                            seed=50, max_attempts=100)

# sa_run_stats, sa_run_curves = runner_return.run()
